...
public class TestFeaturesConfig
{
    ...
    public void testDefaults()
    {
        assertRecordedDefaults(ConfigAssertions.recordDefaults(FeaturesConfig.class)
                ...
                .setRewriteGroupedNotEqualExistsToFilteredSemiJoin(false)
                .setRewriteRepeatedScalarSumToGroupedScalarFilter(false)
                .setPushPartialAggregationThroughJoin(false)
                .setPushAggregationThroughUniqueLookupJoin(true)
                ...
                .setPushSideLocalProjectionThroughJoin(true)
    ...
    public void testExplicitPropertyMappings()
    {
        Map<String, String> properties = new ImmutableMap.Builder<String, String>()
                ...
                .put("optimizer.rewrite-grouped-not-equal-exists-to-filtered-semi-join", "true")
                .put("optimizer.rewrite-repeated-scalar-sum-to-grouped-scalar-filter", "true")
                .put("optimizer.push-partial-aggregation-through-join", "true")
                .put("optimizer.push-aggregation-through-unique-lookup-join", "false")
                ...
                .put("optimizer.push-side-local-projection-through-join", "false")
        ...
        FeaturesConfig expected = new FeaturesConfig()
                ...
                .setRewriteGroupedNotEqualExistsToFilteredSemiJoin(true)
                .setRewriteRepeatedScalarSumToGroupedScalarFilter(true)
                .setPushAggregationThroughUniqueLookupJoin(false)
                ...
                .setPushSideLocalProjectionThroughJoin(false)
