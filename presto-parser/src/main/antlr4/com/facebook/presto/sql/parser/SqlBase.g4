...
unnamedConstraintSpecification
    : constraintType columns=columnAliases constraintQualifiers
    | FOREIGN KEY columns=columnAliases REFERENCES referencedTable=qualifiedName referencedColumns=columnAliases constraintQualifiers
    ;
...
nonReserved
    ...
    | FETCH | FILTER | FIRST | FOLLOWING | FOREIGN | FORMAT | FUNCTION | FUNCTIONS
    ...
    | RANGE | READ | REFERENCES | REFRESH | RELY | RENAME | REPEATABLE | REPLACE | RESET | RESPECT | RESTRICT | RETAIN | RETENTION | RETURN | RETURNS | REVOKE | ROLE | ROLES | ROLLBACK | ROW | ROWS
